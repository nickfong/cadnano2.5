...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.grid_dock_widget.setStyleSheet("background-color: #f5f5f5;")
        ...
        self.grid_graphics_view.setStyleSheet("QGraphicsView { background-color: rgb(96.5%, 96.5%, 96.5%); }")
        ...
        self.path_dock_widget.setStyleSheet("background-color: #f5f5f5;")
        ...
        self.inspector_dock_widget.setStyleSheet("background-color: #f5f5f5;")
...
"")
        ...
        self.sim_dock_widget = SimDockWidget(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sim_dock_widget.sizePolicy().hasHeightForWidth())
        self.sim_dock_widget.setSizePolicy(sizePolicy)
        self.sim_dock_widget.setMinimumSize(QtCore.QSize(200, 200))
        self.sim_dock_widget.setBaseSize(QtCore.QSize(400, 0))
        self.sim_dock_widget.setStyleSheet("background-color: #f5f5f5;")
        self.sim_dock_widget.setObjectName("sim_dock_widget")
        self.sim_dock_widget_contents = QtWidgets.QWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sim_dock_widget_contents.sizePolicy().hasHeightForWidth())
        self.sim_dock_widget_contents.setSizePolicy(sizePolicy)
        self.sim_dock_widget_contents.setObjectName("sim_dock_widget_contents")
        self.sim_dock_widget.setWidget(self.sim_dock_widget_contents)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(1), self.sim_dock_widget)
        self.console_dock_widget = QtWidgets.QDockWidget(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.console_dock_widget.sizePolicy().hasHeightForWidth())
        self.console_dock_widget.setSizePolicy(sizePolicy)
        self.console_dock_widget.setMinimumSize(QtCore.QSize(200, 123))
        self.console_dock_widget.setBaseSize(QtCore.QSize(250, 0))
        self.console_dock_widget.setObjectName("console_dock_widget")
        self.console_root_widget = ConsoleRootWidget()
        self.console_root_widget.setMinimumSize(QtCore.QSize(200, 0))
        self.console_root_widget.setStyleSheet("QWidget { background-color: rgb(96.5%, 96.5%, 96.5%); }")
        self.console_root_widget.setObjectName("console_root_widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.console_root_widget)
        ...
        self.verticalLayout.addWidget(self.console_output_textedit)
        self.console_input_textedit = ConsoleInput(self.console_root_widget)
        self.console_input_textedit.setMaximumSize(QtCore.QSize(16777215, 24))
        self.console_input_textedit.setStyleSheet("QPlainTextEdit { background-color: \"#eeeeee\";}")
        self.console_input_textedit.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.console_input_textedit.setFrameShadow(QtWidgets.QFrame.Plain)
        self.console_input_textedit.setLineWidth(0)
        self.console_input_textedit.setMidLineWidth(0)
        self.console_input_textedit.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.console_input_textedit.setTabStopWidth(80)
        self.console_input_textedit.setBackgroundVisible(False)
        self.console_input_textedit.setObjectName("console_input_textedit")
        self.verticalLayout.addWidget(self.console_input_textedit)
        self.console_dock_widget.setWidget(self.console_root_widget)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.console_dock_widget)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/parttools/slice"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_slice.setIcon(icon36)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/parttools/path"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_path.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/parttools/console"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_console.setIcon(icon38)
        ...
        self.filter_view_toolbar.addAction(self.action_console)
        self.filter_view_toolbar.addAction(self.action_inspector)
        self.filter_view_toolbar.addAction(self.action_sim)
        ...
        self.menuView.addAction(self.action_sim)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sim_dock_widget.setWindowTitle(_translate("MainWindow", "Sim"))
        self.console_dock_widget.setWindowTitle(_translate("MainWindow", "Console"))
        self.console_input_textedit.setPlaceholderText(_translate("MainWindow", "Enter command or type \"help\""))
